...
class CStruct2GDB:
    ...
    def read_field(self, field: str) -> gdb.Value:
        ...
        if hasattr(field_type, "_length_"):  # f is a ctypes Array
            ...
            return pwndbg.gdblib.memory.get_typed_pointer_value(t.array(field_type._length_ - 1), field_address)
        return pwndbg.gdblib.memory.get_typed_pointer_value(C2GDB_MAPPING[field_type], field_address)
